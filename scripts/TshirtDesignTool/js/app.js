...
var TShirtDesignTool = (function() {
    ...
    var _canvasInit = function() {
        ...
        var img = new Image();
        img.src = 'scripts/TshirtDesignTool/img/' + TShirtDesignTool.selectedTShirt.color + '-1-' + TShirtDesignTool.selectedTShirt.side + '.jpg';
        img.onload = function() {
        ...
        canvas.on('mouse:down', function(e) {
            if (e.target === undefined) {
                _changePanelOnRemove(TShirtDesignTool.lastSelectedObject);
            }
        });
        ...
        init: function() {
            ...
            $('#addName,#addNumber,#nameInch,#numberInch').change(function(e) {
                switch (e.currentTarget.id) {
                    case 'addName':
                        addName.checked ? TShirtDesignTool.addPersonalizedName() : TShirtDesignTool.removePersonalizedName();
                        break;
                    case 'addNumber':
                        addNumber.checked ? TShirtDesignTool.addPersonalizedNumber() : TShirtDesignTool.removePersonalizedNumber();
                        break;
                    case 'nameInch':
            ...
            $('#saveData').click(function(e) {
                ...
                ['designFront', 'designBack'].forEach(function(sideName, i) {
                    ...
                    window.canvas.clear();
                    var imageSrc = 'scripts/TshirtDesignTool/img/' + TShirtDesignTool.selectedTShirt.color + '-1-' + sideName[6] + '.jpg';
                    ...
                    zip.file(sideName + '.png', window.canvas.toDataURL("image/png").replace('data:image/png;base64,', ''), {
                        base64: true
                    });
